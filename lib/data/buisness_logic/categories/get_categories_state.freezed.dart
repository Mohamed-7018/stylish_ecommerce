...
/// @nodoc
abstract class $GetCategoriesStateCopyWith<T, $Res> {
  factory $GetCategoriesStateCopyWith(GetCategoriesState<T> value,
          $Res Function(GetCategoriesState<T>) then) =
      _$GetCategoriesStateCopyWithImpl<T, $Res, GetCategoriesState<T>>;
}

/// @nodoc
class _$GetCategoriesStateCopyWithImpl<T, $Res,
        $Val extends GetCategoriesState<T>>
    implements $GetCategoriesStateCopyWith<T, $Res> {
...
class __$$IdleImplCopyWithImpl<T, $Res>
    extends _$GetCategoriesStateCopyWithImpl<T, $Res, _$IdleImpl<T>>
...
class _$IdleImpl<T> implements Idle<T> {
  ...
  @override
  String toString() {
    return 'GetCategoriesState<$T>.idle()';
  }
...
abstract class Idle<T> implements GetCategoriesState<T> {
...
class __$$LoadingImplCopyWithImpl<T, $Res>
    extends _$GetCategoriesStateCopyWithImpl<T, $Res, _$LoadingImpl<T>>
...
abstract class Loading<T> implements GetCategoriesState<T> {
...
class __$$SuccessImplCopyWithImpl<T, $Res>
    extends _$GetCategoriesStateCopyWithImpl<T, $Res, _$SuccessImpl<T>>
...
class _$SuccessImpl<T> implements Success<T> {
  ...
  @override
  String toString() {
    return 'GetCategoriesState<$T>.success(data: $data)';
  }
...
abstract class Success<T> implements GetCategoriesState<T> {
...
class __$$ErrorImplCopyWithImpl<T, $Res>
    extends _$GetCategoriesStateCopyWithImpl<T, $Res, _$ErrorImpl<T>>
...
class _$ErrorImpl<T> implements Error<T> {
  ...
  @override
  String toString() {
    return 'GetCategoriesState<$T>.error(networkExceptions: $networkExceptions)';
  }
...
abstract class Error<T> implements GetCategoriesState<T> {
