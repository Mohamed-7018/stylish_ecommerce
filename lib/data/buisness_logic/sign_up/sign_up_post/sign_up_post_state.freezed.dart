...
part of 'sign_up_post_state.dart';
...
/// @nodoc
abstract class $SignUpPostStateCopyWith<T, $Res> {
  factory $SignUpPostStateCopyWith(
          SignUpPostState<T> value, $Res Function(SignUpPostState<T>) then) =
      _$SignUpPostStateCopyWithImpl<T, $Res, SignUpPostState<T>>;
}

/// @nodoc
class _$SignUpPostStateCopyWithImpl<T, $Res, $Val extends SignUpPostState<T>>
    implements $SignUpPostStateCopyWith<T, $Res> {
  _$SignUpPostStateCopyWithImpl(this._value, this._then);
...
class __$$IdleImplCopyWithImpl<T, $Res>
    extends _$SignUpPostStateCopyWithImpl<T, $Res, _$IdleImpl<T>>
...
abstract class Idle<T> implements SignUpPostState<T> {
...
class __$$LoadingImplCopyWithImpl<T, $Res>
    extends _$SignUpPostStateCopyWithImpl<T, $Res, _$LoadingImpl<T>>
...
class _$LoadingImpl<T> implements Loading<T> {
  ...
  @override
  String toString() {
    return 'SignUpPostState<$T>.loading()';
  }
...
abstract class Loading<T> implements SignUpPostState<T> {
...
class __$$SuccessImplCopyWithImpl<T, $Res>
    extends _$SignUpPostStateCopyWithImpl<T, $Res, _$SuccessImpl<T>>
...
class _$SuccessImpl<T> implements Success<T> {
  ...
  @override
  String toString() {
    return 'SignUpPostState<$T>.success(data: $data)';
  }
...
abstract class Success<T> implements SignUpPostState<T> {
...
class __$$ErrorImplCopyWithImpl<T, $Res>
    extends _$SignUpPostStateCopyWithImpl<T, $Res, _$ErrorImpl<T>>
...
class _$ErrorImpl<T> implements Error<T> {
  ...
  @override
  String toString() {
    return 'SignUpPostState<$T>.error(networkExceptions: $networkExceptions)';
  }
...
abstract class Error<T> implements SignUpPostState<T> {
