...
part of 'get_banners_state.dart';
...
/// @nodoc
abstract class $GetBannersStateCopyWith<T, $Res> {
  factory $GetBannersStateCopyWith(
          GetBannersState<T> value, $Res Function(GetBannersState<T>) then) =
      _$GetBannersStateCopyWithImpl<T, $Res, GetBannersState<T>>;
}

/// @nodoc
class _$GetBannersStateCopyWithImpl<T, $Res, $Val extends GetBannersState<T>>
    implements $GetBannersStateCopyWith<T, $Res> {
...
class __$$IdleImplCopyWithImpl<T, $Res>
    extends _$GetBannersStateCopyWithImpl<T, $Res, _$IdleImpl<T>>
...
abstract class Idle<T> implements GetBannersState<T> {
...
class __$$LoadingImplCopyWithImpl<T, $Res>
    extends _$GetBannersStateCopyWithImpl<T, $Res, _$LoadingImpl<T>>
...
class _$LoadingImpl<T> implements Loading<T> {
  ...
  @override
  String toString() {
    return 'GetBannersState<$T>.loading()';
  }
...
abstract class Loading<T> implements GetBannersState<T> {
...
class __$$SuccessImplCopyWithImpl<T, $Res>
    extends _$GetBannersStateCopyWithImpl<T, $Res, _$SuccessImpl<T>>
...
class _$SuccessImpl<T> implements Success<T> {
  ...
  @override
  String toString() {
    return 'GetBannersState<$T>.success(data: $data)';
  }
...
abstract class Success<T> implements GetBannersState<T> {
...
class __$$ErrorImplCopyWithImpl<T, $Res>
    extends _$GetBannersStateCopyWithImpl<T, $Res, _$ErrorImpl<T>>
...
class _$ErrorImpl<T> implements Error<T> {
  ...
  @override
  String toString() {
    return 'GetBannersState<$T>.error(networkExceptions: $networkExceptions)';
  }
...
abstract class Error<T> implements GetBannersState<T> {
